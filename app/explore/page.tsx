    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        <div className="mb-4 sm:mb-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Explore All Notes</h1>
          <p className="text-sm sm:text-base text-gray-600">Discover and interact with notes from all students</p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-4 sm:mt-6">
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full sm:w-auto pl-10 pr-8 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent text-gray-900 bg-white text-base"
              >
                  ...
                  <div className="flex items-center justify-between pt-3 sm:pt-4 border-t">
                    <div className="flex items-center space-x-2 sm:space-x-4">
                      <button
                        ...
                        className={`flex items-center space-x-1 px-2 sm:px-3 py-1.5 sm:py-1 rounded-lg transition-colors touch-target ${
                          note.is_liked
                      ...
                      <Link
                        ...
                        className="flex items-center space-x-1 px-2 sm:px-3 py-1.5 sm:py-1 rounded-lg bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors touch-target"
                      >
